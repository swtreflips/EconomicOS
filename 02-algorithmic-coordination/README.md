...
## What This Looks Like in Venezuela/Colombia

- **Composite activity indexes**: Combining Pago Movil volumes + satellite nighttime lights + web-scraped prices into a single "how is the economy doing right now?" signal for each region
